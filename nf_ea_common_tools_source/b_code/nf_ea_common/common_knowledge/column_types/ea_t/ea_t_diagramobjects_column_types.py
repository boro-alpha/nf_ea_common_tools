...
class EaTDiagramobjectsColumnTypes(
    EaTColumnTypes):
    T_DIAGRAMOBJECTS_DIAGRAM_IDS = auto()
    T_DIAGRAMOBJECTS_OBJECT_IDS = auto()
    T_DIAGRAMOBJECTS_RECT_TOPS = auto()
    T_DIAGRAMOBJECTS_RECT_LEFTS = auto()
    T_DIAGRAMOBJECTS_RECT_RIGHTS = auto()
    T_DIAGRAMOBJECTS_RECT_BOTTOMS = auto()
    T_DIAGRAMOBJECTS_SEQUENCES = auto()
    T_DIAGRAMOBJECTS_OBJECT_STYLES = auto()
    T_DIAGRAMOBJECTS_INSTANCE_IDS = auto()
