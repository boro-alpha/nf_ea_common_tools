...
class EaTConnectorColumnTypes(
    ...
    T_CONNECTOR_START_OBJECT_IDS = auto()
    ...
    T_CONNECTOR_SOURCE_IS_AGGREGATE = auto()
    T_CONNECTOR_DEST_IS_AGGREGATE = auto()
    T_CONNECTOR_LINE_STYLES = auto()
    T_CONNECTOR_ROUTE_STYLES = auto()
    T_CONNECTOR_IS_BOLD = auto()
    T_CONNECTOR_LINE_COLORS = auto()
    T_CONNECTOR_SOURCE_CARDINALITIES = auto()
    T_CONNECTOR_DEST_CARDINALITIES = auto()
