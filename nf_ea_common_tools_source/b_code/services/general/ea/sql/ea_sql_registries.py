from nf_ea_common_tools_source.b_code.services.general.ea.sql.ea_sql_service.ea_sql_dataframe_creator import create_ea_sql_dataframe
...
class EaSqlRegistries(
    ...
    def __get_ea_sql_dataframe(
            ...
            -> DataFrame:
        if ea_collection_type in self.dictionary_of_collections:
            return \
                self.dictionary_of_collections[ea_collection_type]
