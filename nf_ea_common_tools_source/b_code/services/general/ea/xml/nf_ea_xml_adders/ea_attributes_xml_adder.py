...
def add_ea_attributes_to_xml_root_element(
    ...
    nf_uuids_to_classifier_names_dataframe = \
        DataFrame(
            ea_classifiers[[nf_uuid_column, object_name_column]])

    nf_uuids_to_classifier_names_map = \
        nf_uuids_to_classifier_names_dataframe.set_index(nf_uuid_column)[object_name_column].to_dict()
    ...
    for index, ea_attribute_row in ea_attributes.iterrows():
        __add_ea_attribute_to_xml_tree(
            nf_uuids_to_classifier_names_map=nf_uuids_to_classifier_names_map,
            ea_attribute_identifier=start_ea_identifier + int(index),
            xml_element_for_ea_attributes=xml_element_for_ea_attributes,
            ea_attribute_value=ea_attribute_row[name_column_name],
            ea_attribute_default=ea_attribute_row[default_column_name],
            ea_attribute_container_nf_uuid=ea_attribute_row[containing_classifier_column_name],
            ea_attribute_classifier_nf_uuid=ea_attribute_row[classifying_classifier_column_name])
...
def __add_ea_attribute_to_xml_tree(
    ...
    try:
        ea_attribute_classifier_name = \
            nf_uuids_to_classifier_names_map[ea_attribute_classifier_nf_uuid]
    ...
    if ea_attribute_default == DEFAULT_NULL_VALUE:
