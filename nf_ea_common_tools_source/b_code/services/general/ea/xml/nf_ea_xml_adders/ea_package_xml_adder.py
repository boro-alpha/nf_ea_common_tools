...
def add_ea_package_to_xml_tree(
    ...
    package_was_added = \
        add_ea_package_to_xml_tree_if_possible(
            nf_uuid=ea_package_row[nf_uuid_column_name],
            ea_identifier_for_package=start_ea_identifier_for_new_packages + int(index),
            ea_identifier_for_object=start_ea_identifier_for_new_objects + int(index),
            ...
            ea_package_parent_nf_uuid=ea_package_row[parent_column_name],
            ea_package_name=ea_package_row[name_column_name])

    if not package_was_added:
        recyclable_packages.loc[index] = \
            ea_package_row
...
def add_ea_package_to_xml_tree_if_possible(
        ...
        xml_element_for_packages_as_objects: Element) \
        -> bool:
    if ea_package_parent_nf_uuid == DEFAULT_NULL_VALUE:
    ...
    if ea_package_parent_ea_guid == DEFAULT_NULL_VALUE:
        return \
            False
    ...
    if ea_package_parent_ea_identifier == DEFAULT_NULL_VALUE:
        return \
            False
