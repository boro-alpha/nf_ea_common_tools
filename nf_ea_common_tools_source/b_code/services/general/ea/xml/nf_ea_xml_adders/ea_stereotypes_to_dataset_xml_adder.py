...
from nf_ea_common_tools_source.b_code.services.general.ea.xml.nf_ea_xml_adders.nf_ea_xml_add_helpers import add_xml_row_element_to_xml_data_reference_table_element
from nf_ea_common_tools_source.b_code.services.general.nf_ea.com.common_knowledge.column_types.nf_ea_com_additional_column_types import NfEaComAdditionalColumnTypes
...
def add_ea_stereotypes_to_dataset_xml_root_element(
        ...
        -> Element:
    for ea_stereotype_tuple in ea_stereotypes.itertuples():
...
def __add_ea_stereotype_to_xml_tree(
    ...
    if ea_stereotype_name == DEFAULT_NULL_VALUE:
        ea_stereotype_name = ''

    if ea_stereotype_notes == DEFAULT_NULL_VALUE:
        ea_stereotype_notes = ''
    ...
    if ea_stereotype_nf_uuid != DEFAULT_NULL_VALUE:
