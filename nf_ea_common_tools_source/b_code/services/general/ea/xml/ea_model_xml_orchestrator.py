from nf_ea_common_tools_source.b_code.services.general.ea.xml.nf_ea_xml_adders.native_xml_preparer import prepare_native_xml
from nf_ea_common_tools_source.b_code.services.general.ea.xml.nf_ea_xml_io_agents.xml_serialiser import serialise_xml
from nf_ea_common_tools_source.b_code.services.general.ea.xml.nf_ea_xml_loaders.ea_attributes_xml_loader import map_and_xml_load_ea_attributes
from nf_ea_common_tools_source.b_code.services.general.ea.xml.nf_ea_xml_loaders.ea_classifiers_xml_loader import map_and_xml_load_ea_non_proxy_classifiers, map_and_xml_load_ea_proxy_classifiers
from nf_ea_common_tools_source.b_code.services.general.ea.xml.nf_ea_xml_loaders.ea_connectors_xml_loader import map_and_xml_load_ea_connectors
...
def orchestrate_creation_xml_native_file_for_import(
    ...
    xml_root_element, xml_root_element_guid, xml_element_for_packages = \
        prepare_native_xml(
    ...
    start_ea_identifier_for_new_objects += 1

    start_ea_identifier_for_new_packages += 1
...
def __map_and_load(
    ...
    xml_root_element, xml_element_for_connectors, start_ea_identifier_for_new_connectors = \
    ...
    if not ea_connectors_connecting_proxy_connector.empty:
        xml_root_element, xml_element_for_connectors, start_ea_identifier_for_new_connectors = \
            map_and_xml_load_ea_connectors(
