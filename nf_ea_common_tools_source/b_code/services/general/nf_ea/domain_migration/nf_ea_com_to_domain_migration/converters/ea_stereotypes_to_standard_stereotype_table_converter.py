...
from nf_ea_common_tools_source.b_code.services.general.nf_ea.domain_migration.common.column_name_mappings.standard_stereotype_to_nf_ea_com_column_name_bimapping import get_nf_ea_com_column_name_to_standard_stereotype_dictionary
...
def convert_ea_stereotypes_to_standard_stereotype_table(
    ...
    standard_tables_dictionary[NfEaComCollectionTypes.EA_STEREOTYPES.collection_name] = \
        nf_ea_com_table_filtered_and_renamed
