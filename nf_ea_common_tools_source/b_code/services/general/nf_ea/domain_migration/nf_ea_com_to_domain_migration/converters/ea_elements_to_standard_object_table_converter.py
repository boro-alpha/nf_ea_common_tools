...
from nf_ea_common_tools_source.b_code.services.general.nf_ea.domain_migration.common.column_name_mappings.standard_classifier_to_nf_ea_com_column_name_bimapping import get_nf_ea_com_column_name_to_standard_classifier_dictionary
...
def convert_ea_elements_to_standard_object_table(
        ...
        -> dict:
    ea_elements = \
        nf_ea_com_universe.nf_ea_com_registry.dictionary_of_collections[nf_ea_com_classifiers_collection_type]
    ...
    standard_tables_dictionary[input_object_table_name] = \
        nf_ea_com_table_filtered_and_renamed
