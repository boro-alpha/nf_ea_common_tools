...
def add_human_readable_names_to_standard_tables_dictionary(
    ...
    standard_tables_dictionary = \
        __add_package_names_to_objects(
    ...
    standard_tables_dictionary = \
        __add_object_names_to_connectors(
            standard_tables_dictionary=standard_tables_dictionary,
...
def __add_package_names_to_objects(
        ...
        collection_type: NfEaComCollectionTypes) \
            -> dict:
    objects_dataframe = \
        standard_tables_dictionary[collection_type.collection_name]

    packages_dataframe = \
        standard_tables_dictionary[NfEaComCollectionTypes.EA_PACKAGES.collection_name]

    objects_with_package_names_dataframe = \
        left_merge_dataframes(
            master_dataframe=objects_dataframe,
            master_dataframe_key_columns=[StandardObjectTableColumnTypes.PARENT_PACKAGE_NF_UUIDS.column_name],
            merge_suffixes=['_master', '_packages'],
            foreign_key_dataframe=packages_dataframe,
            foreign_key_dataframe_fk_columns=[StandardObjectTableColumnTypes.NF_UUIDS.column_name],
...
def __add_object_names_to_connectors(
        ...
        place_uml_names_column_type: StandardConnectorTableColumnTypes) \
            -> dict:
    objects_dataframe = \
        standard_tables_dictionary[NfEaComCollectionTypes.EA_CLASSIFIERS.collection_name]

    connectors_dataframe = \
        standard_tables_dictionary[NfEaComCollectionTypes.EA_CONNECTORS.collection_name]

    connectors_with_place_names_dataframe = \
        left_merge_dataframes(
            master_dataframe=connectors_dataframe,
            master_dataframe_key_columns=[place_nf_uuids_column_type.column_name],
            merge_suffixes=['_connectors', '_objects'],
