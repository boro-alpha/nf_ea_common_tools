from nf_ea_common_tools_source.b_code.services.general.nf_ea.domain_migration.domain_to_nf_ea_com_migration.convertors.tables.standard_stereotype_groups_converter import convert_standard_stereotype_group_table_to_stereotype_groups
...
def convert_stereotype_group_tables(
        ...
        -> dict:
    for stereotype_group_base_name in stereotype_group_base_names:
        nf_ea_com_dictionary = \
            __convert_stereotype_group_table(
