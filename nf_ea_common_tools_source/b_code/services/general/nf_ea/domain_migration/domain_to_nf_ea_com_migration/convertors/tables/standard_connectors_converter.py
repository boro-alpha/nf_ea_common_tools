...
from nf_ea_common_tools_source.b_code.services.general.nf_ea.domain_migration.common.column_name_mappings.standard_connector_to_nf_ea_com_column_name_bimapping import get_standard_connector_to_nf_ea_com_column_name_dictionary
...
def convert_standard_linked_table_to_connectors(
    ...
    if needs_uuid_generation:
        standard_linked_table_dataframe[NfColumnTypes.NF_UUIDS.column_name] = \
    ...
    standard_linked_table_filtered_and_renamed_for_connectors = \
