...
from nf_ea_common_tools_source.b_code.services.general.nf_ea.domain_migration.common.column_name_mappings.standard_classifier_to_nf_ea_com_column_name_bimapping import get_standard_classifier_to_nf_ea_com_column_name_dictionary
...
def convert_standard_object_table_to_classifiers(
    ...
    standard_object_table_filtered_and_renamed = \
        dataframe_filter_and_rename(
            dataframe=standard_table_dictionary[input_object_table_name],
