...
def convert_standard_typed_linked_table_to_connectors_pc(
    ...
    ea_connectors_pc_dataframe = \
        standard_typed_linked_table.merge(
            right=nf_ea_com_dictionary[nf_ea_com_classifiers_collection_type],
            how='left',
    ...
    ea_connectors_pc_dataframe_renaming_dictionary = {
        NfColumnTypes.NF_UUIDS.column_name + '_y': NfEaComColumnTypes.ELEMENTS_SUPPLIER_PLACE1_END_CONNECTORS.column_name,
    ...
    ea_connectors_pc_dataframe_filtered_and_renamed[NfEaComColumnTypes.EXPLICIT_OBJECTS_EA_OBJECT_NAME.column_name] = \
        numpy.nan

    ea_connectors_pc_dataframe_filtered_and_renamed[NfEaComColumnTypes.CONNECTORS_ELEMENT_TYPE_NAME.column_name] = \
