...
from nf_ea_common_tools_source.b_code.nf_ea_common.common_knowledge.column_types.nf_domains.standard_attribute_table_column_types import StandardAttributeTableColumnTypes
...
def convert_standard_attribute_table_to_attributes(
    ...
    attribute_table = \
        standard_table_dictionary[input_attribute_table_name]
    ...
    attribute_table_filtered_for_ea_attributes[ea_attributes_nf_uuids_column_name] = \
