from nf_ea_common_tools_source.b_code.services.general.nf_ea.domain_migration.domain_to_nf_ea_com_migration.convertors.tables.standard_connectors_converter import convert_standard_linked_table_to_connectors
...
def convert_connector_tables(
        ...
        -> dict:
    for connector_base_name in connector_base_names:
        nf_ea_com_dictionary = \
            __convert_connector_table(
