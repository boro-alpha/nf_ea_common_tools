from nf_ea_common_tools_source.b_code.services.general.nf_ea.domain_migration.domain_to_nf_ea_com_migration.convertors.tables.standard_stereotypes_converter import convert_standard_stereotype_table_to_stereotypes
...
def convert_stereotype_tables(
        ...
        -> dict:
    for stereotype_base_name in stereotype_base_names:
        nf_ea_com_dictionary = \
            __convert_stereotype_table(
