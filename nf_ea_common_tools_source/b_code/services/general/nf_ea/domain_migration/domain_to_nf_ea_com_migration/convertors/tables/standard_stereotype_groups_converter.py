...
from nf_ea_common_tools_source.b_code.services.general.nf_ea.domain_migration.common.column_name_mappings.standard_stereotype_group_to_nf_ea_com_column_name_bimapping import get_standard_stereotype_group_to_nf_ea_com_column_name_dictionary
...
def convert_standard_stereotype_group_table_to_stereotype_groups(
    ...
    standard_stereotype_group_table_filtered_and_renamed = \
        dataframe_filter_and_rename(
            dataframe=standard_table_dictionary[input_stereotype_group_table_name],
