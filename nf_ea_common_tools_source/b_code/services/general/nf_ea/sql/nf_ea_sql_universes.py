...
from nf_ea_common_tools_source.b_code.services.general.nf_ea.sql.nf_ea_sql_registries import NfEaSqlRegistries
...
class NfEaSqlUniverses:
    ...
    def get_extended_ea_t_table_dataframe(
        ...
        extended_ea_t_table_dataframe = \
            self.nf_ea_sql_registry.get_extended_ea_t_table_dataframe(
