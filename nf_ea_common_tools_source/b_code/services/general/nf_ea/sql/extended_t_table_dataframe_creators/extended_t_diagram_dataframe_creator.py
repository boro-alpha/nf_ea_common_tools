...
def create_extended_t_diagram_dataframe(
    ...
    extended_t_diagram_dataframe['t_diagram_ea_human_readable_names'] = \
        '(' + extended_t_diagram_dataframe[EaTDiagramColumnTypes.T_DIAGRAM_TYPES.nf_column_name] + ' diagram) ' + \
        extended_t_diagram_dataframe[EaTDiagramColumnTypes.T_DIAGRAM_NAMES.nf_column_name]
...
def __extend_with_object_data(
    ...
    extended_t_diagram_dataframe = \
        left_merge_dataframes(
            ...
            master_dataframe_key_columns=['t_diagram_package_ea_guids'],
            merge_suffixes=['_master', '_linked'],
    ...
    extended_t_diagram_dataframe = \
        extended_t_diagram_dataframe.fillna(
            DEFAULT_NULL_VALUE)
...
def __extend_with_package_hierarchy_data(
    ...
    extended_t_diagram_dataframe = \
        left_merge_dataframes(
            master_dataframe=extended_t_diagram_dataframe,
            master_dataframe_key_columns=[EaTDiagramColumnTypes.T_DIAGRAM_PACKAGE_IDS.nf_column_name],
            merge_suffixes=['_diagram', '_object'],
            foreign_key_dataframe=extended_t_package_dataframe,
            foreign_key_dataframe_fk_columns=['package_ids_0'],
            foreign_key_dataframe_other_column_rename_dictionary={
                NfColumnTypes.NF_UUIDS.column_name: 't_diagram_package_nf_uuids',
