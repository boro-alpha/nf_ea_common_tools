...
from nf_ea_common_tools_source.b_code.nf_ea_common.common_knowledge.column_types.extended_t.extended_t_diagramobjects_column_types import ExtendedTDiagramobjectsColumnTypes
...
def create_extended_t_diagramobjects_dataframe(
    ...
    extended_t_diagramobjects_dataframe = \
        __extend_with_extended_t_object_data(
            extended_t_diagramobjects_dataframe=extended_t_diagramobjects_dataframe,
...
def __extend_with_extended_t_diagram_data(
    ...
    extended_t_diagramobjects_dataframe = \
        left_merge_dataframes(
            ...
            master_dataframe_key_columns=[EaTDiagramobjectsColumnTypes.T_DIAGRAMOBJECTS_DIAGRAM_IDS.to_string()],
            merge_suffixes=['_diagramobjects', '_diagram'],
...
def __extend_with_extended_t_object_data(
    ...
    extended_t_diagramobjects_dataframe = \
        left_merge_dataframes(
            master_dataframe=extended_t_diagramobjects_dataframe,
            master_dataframe_key_columns=[EaTDiagramobjectsColumnTypes.T_DIAGRAMOBJECTS_OBJECT_IDS.to_string()],
            merge_suffixes=['_diagramobjects', '_object'],
...
def __extend_with_composite_data(
        extended_t_diagramobjects_dataframe: DataFrame) \
        -> DataFrame:
    if extended_t_diagramobjects_dataframe.shape[0] > 0:
        extended_t_diagramobjects_dataframe[
    ...
    extended_t_diagramobjects_dataframe[
        ...
        extended_t_diagramobjects_dataframe[ExtendedTObjectColumnTypes.T_OBJECT_EA_HUMAN_READABLE_NAMES.column_name] + ' in ' + \
        extended_t_diagramobjects_dataframe['t_diagram_ea_human_readable_names']
...
def __get_composite_ea_guid(
    ...
    object_ea_guid = \
        row[EaTObjectColumnTypes.T_OBJECT_EA_GUIDS.nf_column_name]
