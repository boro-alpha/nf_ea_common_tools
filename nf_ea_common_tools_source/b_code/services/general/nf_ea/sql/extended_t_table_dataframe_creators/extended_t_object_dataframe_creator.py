...
def create_extended_t_object_dataframe(
    ...
    extended_t_object_dataframe[
        ...
        '(' + extended_t_object_dataframe[EaTObjectColumnTypes.T_OBJECT_TYPES.nf_column_name] + ') ' + \
        extended_t_object_dataframe[EaTObjectColumnTypes.T_OBJECT_NAMES.nf_column_name]
...
def __extend_with_object_data(
    ...
    extended_t_object_dataframe = \
        left_merge_dataframes(
            ...
            master_dataframe_key_columns=[EaTObjectColumnTypes.T_OBJECT_PARENT_IDS.nf_column_name],
    ...
    extended_t_object_dataframe = \
        extended_t_object_dataframe.fillna(
            DEFAULT_NULL_VALUE)
...
def __extend_with_package_data(
    ...
    extended_t_object_dataframe = \
        left_merge_dataframes(
            master_dataframe=extended_t_object_dataframe,
            master_dataframe_key_columns=[EaTObjectColumnTypes.T_OBJECT_PACKAGE_IDS.nf_column_name],
