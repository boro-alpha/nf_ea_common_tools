...
from nf_common_source.code.services.identification_services.uuid_service.uuid_from_list_factory import create_uuid_from_list
...
from nf_ea_common_tools_source.b_code.nf_ea_common.common_knowledge.column_types.ea_t.ea_t_diagram_column_types import \
    EaTDiagramColumnTypes
from nf_ea_common_tools_source.b_code.nf_ea_common.common_knowledge.column_types.extended_t.extended_t_connector_column_types import \
...
from nf_ea_common_tools_source.b_code.nf_ea_common.common_knowledge.column_types.extended_t.extended_t_diagramlinks_column_types import ExtendedTDiagramlinksColumnTypes
from nf_ea_common_tools_source.b_code.services.general.nf_ea.sql.extended_t_table_dataframe_creators.common_extensions.nf_identity_extender import \
...
def create_extended_t_diagramlinks_dataframe(
    ...
    log_message(
        message='creating ' + collection_type_name + ' dataframe')
    ...
    extended_t_diagramlinks_dataframe = \
        __extend_with_extended_t_diagram_data(
    ...
    extended_t_diagramlinks_dataframe = \
        __extend_with_extended_t_connector_data(
            extended_t_diagramlinks_dataframe=extended_t_diagramlinks_dataframe,
            extended_t_connector_dataframe=extended_t_connector_dataframe)

    extended_t_diagramlinks_dataframe = \
        __extend_with_composite_data(
            extended_t_diagramlinks_dataframe=extended_t_diagramlinks_dataframe)

    log_message(
        message='created ' + collection_type_name + ' dataframe')
...
def __extend_with_extended_t_diagram_data(
    ...
    extended_t_diagramlinks_dataframe = \
        left_merge_dataframes(
            ...
            master_dataframe_key_columns=[EaTDiagramlinksColumnTypes.T_DIAGRAMLINKS_DIAGRAM_IDS.to_string()],
            merge_suffixes=['_diagramlinks', '_diagram'],
            foreign_key_dataframe=extended_t_diagram_dataframe,
            foreign_key_dataframe_fk_columns=[EaTDiagramColumnTypes.T_DIAGRAM_IDS.nf_column_name],
...
def __extend_with_extended_t_connector_data(
    ...
    extended_t_diagramlinks_dataframe = \
        left_merge_dataframes(
            master_dataframe=extended_t_diagramlinks_dataframe,
            master_dataframe_key_columns=[EaTDiagramlinksColumnTypes.T_DIAGRAMLINKS_CONNECTOR_IDS.to_string()],
            merge_suffixes=['_diagramlinks', '_connector'],
            foreign_key_dataframe=extended_t_connector_dataframe,
            foreign_key_dataframe_fk_columns=[EaTConnectorColumnTypes.T_CONNECTOR_IDS.nf_column_name],
            foreign_key_dataframe_other_column_rename_dictionary={
...
def __extend_with_composite_data(
    ...
    extended_t_diagramlinks_dataframe[
        ...
        extended_t_diagramlinks_dataframe[ExtendedTConnectorColumnTypes.T_CONNECTOR_EA_HUMAN_READABLE_NAMES.column_name] + ' in ' + \
        extended_t_diagramlinks_dataframe['t_diagram_ea_human_readable_names']
...
def __get_composite_ea_guid(
        ...
        -> str:
    diagram_ea_guid = \
        row[EaTDiagramColumnTypes.T_DIAGRAM_EA_GUIDS.nf_column_name]

    connector_ea_guid = \
        row[EaTConnectorColumnTypes.T_CONNECTOR_EA_GUIDS.nf_column_name]
