...
def create_extended_t_attribute_dataframe(
    ...
    extended_t_attribute_dataframe['t_attribute_ea_human_readable_names'] = \
        '(attribute) ' + extended_t_attribute_dataframe['attributed_t_object_names'] + '.' + \
        extended_t_attribute_dataframe[EaTAttributeColumnTypes.T_ATTRIBUTE_NAMES.nf_column_name]
...
def __extend_with_object_data(
    ...
    extended_t_attribute_dataframe = \
        left_merge_dataframes(
            ...
            master_dataframe_key_columns=[EaTAttributeColumnTypes.T_ATTRIBUTE_OBJECT_IDS.nf_column_name],
            merge_suffixes=['_attribute', '_object'],
...
def __extend_with_type_data(
    ...
    extended_t_attribute_dataframe = \
        left_merge_dataframes(
            ...
            master_dataframe_key_columns=[EaTAttributeColumnTypes.T_ATTRIBUTE_CLASSIFIER_T_OBJECT_IDS.nf_column_name],
            merge_suffixes=['_attribute', '_object'],
            foreign_key_dataframe=extended_t_object_dataframe,
            foreign_key_dataframe_fk_columns=[EaTObjectColumnTypes.T_OBJECT_IDS.nf_column_name],
            foreign_key_dataframe_other_column_rename_dictionary=
