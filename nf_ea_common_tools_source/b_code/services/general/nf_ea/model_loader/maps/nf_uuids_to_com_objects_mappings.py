...
class NfUuidsToIDualObjectsMappings:
    __i_dual_packages_map = \
        dict()

    __i_dual_elements_map = \
        dict()

    __i_dual_connectors_map = \
        dict()
    ...
    def get_i_dual_package(
            nf_uuid: str):
        i_dual_package = \
            NfUuidsToIDualObjectsMappings.__i_dual_packages_map[nf_uuid]
    ...
    def get_i_dual_element(
            nf_uuid: str):
        if not nf_uuid in NfUuidsToIDualObjectsMappings.__i_dual_elements_map:
            return INullElement()

        i_dual_element = \
            NfUuidsToIDualObjectsMappings.__i_dual_elements_map[nf_uuid]
    ...
    def get_i_dual_connector(
            nf_uuid: str):
        i_dual_connector = \
            NfUuidsToIDualObjectsMappings.__i_dual_connectors_map[nf_uuid]
