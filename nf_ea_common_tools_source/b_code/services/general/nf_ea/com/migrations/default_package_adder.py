...
from nf_ea_common_tools_source.b_code.nf_ea_common.common_knowledge.constants.nf_ea_model_constants import DEFAULT_MODEL_NAME
...
def add_default_migration_package(
    ...
    if not default_model_package_ea_guid == DEFAULT_NULL_VALUE:
