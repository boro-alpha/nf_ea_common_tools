...
DATA_VISUALIZATION_HIGHER_RELATIONS_NAME = \
    'data_visualization_higher_relations'

DATA_VISUALIZATION_FIRST_CLASS_RELATIONS_NAME = \
    'data_visualization_first_class_relations'
...
EA_MODEL_TABLES_INPUT_FOLDER_TITLE = \
    'Please select ea model tables folder'
