...
from nf_ea_common_tools_source.b_code.services.general.nf_ea.com.processes.model_stats.common.constants import \
    ...
    EA_OBJECT_NAME_COLUMN_NAME, SUPPLIER_PLACE1_END_CONNECTORS_COLUMN_NAME, CLIENT_PLACE2_END_CONNECTORS_COLUMN_NAME, \
...
def get_full_dependency_analysis_edges_table(
    ...
    edges_and_edges_max_level_table = \
        __get_edges_and_edges_max_level_table(
            list_of_all_simple_paths=list_of_all_simple_paths)

    edges_table_with_connector_types_and_names = \
        __add_connector_types_and_names_to_edges_table(
    ...
    full_dependency_analysis_edges_table = \
        __mark_implicit_dependencies_in_edges_table(
...
def __get_edges_and_edges_max_level_table(
    ...
    for path in list_of_all_simple_paths:
    ...
    edges_and_edges_max_level_table = \
        edges_dataframe.groupby(
            [SOURCE_COLUMN_NAME,
             TARGET_COLUMN_NAME], as_index=False)[
...
def __add_connector_types_and_names_to_edges_table(
    ...
    edges_dataframe_attributes_added = \
        left_merge_dataframes(
            ...
            master_dataframe_key_columns=[SOURCE_COLUMN_NAME, TARGET_COLUMN_NAME],
            merge_suffixes=['1', '2'],
