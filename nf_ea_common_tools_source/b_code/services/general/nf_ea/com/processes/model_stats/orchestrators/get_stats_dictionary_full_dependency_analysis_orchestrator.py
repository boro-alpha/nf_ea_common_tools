...
from nf_ea_common_tools_source.b_code.services.general.nf_ea.com.processes.model_stats.common.constants import HIGH_ORDER_TYPE_RELATION_NAME
from nf_ea_common_tools_source.b_code.services.general.nf_ea.com.processes.model_stats.common.constants import FIRST_CLASS_RELATION_NAME
...
from nf_ea_common_tools_source.b_code.services.general.nf_ea.com.processes.model_stats.data_processors.full_dependencies.full_dependency_analysis_dictionary_of_stats_common_getter import get_full_dependency_analysis_dictionary_of_stats_common
from nf_ea_common_tools_source.b_code.services.general.nf_ea.com.processes.model_stats.data_processors.full_dependencies.full_dependency_analysis_dictionary_of_stats_getter import get_full_dependency_analysis_dictionary_of_stats
from nf_ea_common_tools_source.b_code.services.general.nf_ea.com.processes.model_stats.data_processors.full_dependencies.full_dependency_analysis_summary_table_getter import get_full_dependency_analysis_summary_table
from nf_ea_common_tools_source.b_code.services.general.nf_ea.com.processes.model_stats.data_processors.full_dependencies.high_relation_type_dictionary_of_stats_getter import get_high_relation_type_dictionary_of_stats
from nf_ea_common_tools_source.b_code.services.general.nf_ea.com.processes.model_stats.data_processors.input_edges_table.full_dependencies_input_edges_table_getter import get_full_dependencies_input_edges_table
...
def orchestrate_get_stats_dictionary_full_dependency_analysis(
        ...
        -> dict:
    full_dependencies_input_edges_table = \
    ...
    full_dependency_analysis_model_multi_edged_directed_graph = \
    ...
    full_dependency_analysis_dictionary_of_stats = \
        __get_full_dependency_analysis_dictionary_of_stats(
...
def __get_full_dependency_analysis_dictionary_of_stats(
    ...
    full_dependency_analysis_summary_table = \
