...
from nf_ea_common_tools_source.b_code.services.general.nf_ea.com.processes.model_stats.common.services.graph_services.general_edges_dataframe_from_paths_list_generator import get_full_dependency_analysis_edges_table
from nf_ea_common_tools_source.b_code.services.general.nf_ea.com.processes.model_stats.common.services.graph_services.list_of_all_simple_paths_from_graph_getter import get_list_of_all_simple_paths_from_graph
...
from nf_ea_common_tools_source.b_code.services.general.nf_ea.com.processes.model_stats.data_processors.full_dependencies.full_dependencies_path_analysis_master_table_getter import get_full_dependencies_path_analysis_master_table
from nf_ea_common_tools_source.b_code.services.general.nf_ea.com.processes.model_stats.common.constants import \
    FULL_DEPENDENCIES_LEAVES_TABLE_NAME, FULL_DEPENDENCIES_ROOTS_TABLE_NAME, FULL_DEPENDENCIES_PATHS_TABLE_NAME, \
    FULL_DEPENDENCIES_NODES_TABLE_NAME, FULL_DEPENDENCIES_EDGES_TABLE_NAME, FULL_DEPENDENCIES_SUMMARY_TABLE_NAME
...
def get_full_dependency_analysis_dictionary_of_stats_common(
        ...
        -> dict:
    full_dependency_analysis_list_of_leaves = \
    ...
    full_dependency_analysis_list_of_roots = \
        get_list_of_roots_from_multi_edged_directed_graph(
            multi_edged_directed_graph=full_dependency_analysis_model_multi_edged_directed_graph)

    full_dependency_analysis_list_of_all_simple_paths = \
    ...
    full_dependency_analysis_nodes_table = \
    ...
    full_dependency_analysis_edges_table = \
    ...
    full_dependency_analysis_dictionary_of_stats_common = \
        __get_full_dependency_analysis_dictionary_of_stats_common(
...
def __get_full_dependency_analysis_dictionary_of_stats_common(
    ...
    leaves_dataframe = \
        DataFrame(
            data=leaves,
            columns=[FULL_DEPENDENCIES_LEAVES_TABLE_NAME])

    roots_dataframe = \
        DataFrame(
            data=roots,
            columns=[FULL_DEPENDENCIES_ROOTS_TABLE_NAME])
