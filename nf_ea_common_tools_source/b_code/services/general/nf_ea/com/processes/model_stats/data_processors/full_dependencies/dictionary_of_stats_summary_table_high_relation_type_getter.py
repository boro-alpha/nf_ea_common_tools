...
from nf_ea_common_tools_source.b_code.services.general.nf_ea.com.processes.model_stats.common.services.graph_services.number_of_implicit_edges_collector import get_number_of_implicit_edges
from nf_ea_common_tools_source.b_code.services.general.nf_ea.com.processes.model_stats.common.constants import \
    IMPLICIT_EDGES_TABLE_NAME, RELATION_TYPE_COLUMN_NAME, PATH_LEVEL_DEPTH_COLUMN_NAME, \
    NUMBER_OF_NODES, NUMBER_OF_EDGES, NUMBER_OF_IMPLICIT_EDGES, NUMBER_OF_LEAVES, \
    NUMBER_OF_ROOTS, PATH_LEVEL_MAX_DEPTH, STATS_COLUMN_NAME, TOTALS_COLUMN_NAME, NODES_TABLE_NAME_SUFFIX, \
    EDGES_TABLE_NAME_SUFFIX, LEAVES_TABLE_NAME_SUFFIX, ROOTS_TABLE_NAME_SUFFIX
...
def get_dictionary_of_stats_summary_table_high_relation_type(
        ...
        -> DataFrame:
    temporary_dataframe = \
        __generate_temporary_dataframe(
    ...
    number_of_implicit_edges = \
        get_number_of_implicit_edges(
            ...
            dictionary_of_dataframes_table_name=high_relation_type_name + '_' + IMPLICIT_EDGES_TABLE_NAME)
    ...
    data_visualisation_summary_table = \
        __generate_data_visualisation_summary_table(
            relation_type_name=high_relation_type_name,
...
def __generate_temporary_dataframe(
    ...
    temporary_dataframe[PATH_LEVEL_DEPTH_COLUMN_NAME] = \
        full_dependencies_relations_dataframe_filtered[
...
def __get_number_of_nodes(
    ...
    temporary_nodes_dataframe = \
        relation_type_dictionary[relation_type_name + NODES_TABLE_NAME_SUFFIX].index
...
def __get_number_of_edges(
    ...
    temporary_edges_dataframe = \
        relation_type_dictionary[relation_type_name + EDGES_TABLE_NAME_SUFFIX].index
...
def __get_number_of_leaves(
    ...
    temporary_leaves_dataframe = \
        relation_type_dictionary[relation_type_name + LEAVES_TABLE_NAME_SUFFIX].index
...
def __get_number_of_roots(
    ...
    temporary_roots_dataframe = \
        relation_type_dictionary[relation_type_name + ROOTS_TABLE_NAME_SUFFIX].index
...
def __generate_data_visualisation_summary_table(
    ...
    summary_table_stats_names = [
        relation_type_name + '_' + NUMBER_OF_NODES,
        relation_type_name + '_' + NUMBER_OF_EDGES,
        relation_type_name + '_' + NUMBER_OF_IMPLICIT_EDGES,
        relation_type_name + '_' + NUMBER_OF_LEAVES,
        relation_type_name + '_' + NUMBER_OF_ROOTS,
        relation_type_name + '_' + PATH_LEVEL_MAX_DEPTH
    ]
