...
from nf_ea_common_tools_source.b_code.services.general.nf_ea.com.processes.model_stats.common.constants import CONNECTED_PROXIES_NAME
...
from nf_ea_common_tools_source.b_code.services.general.nf_ea.com.processes.model_stats.data_processors.input_edges_table.processed_proxy_connectors_common_input_edges_table_getter import get_processed_proxy_connectors_common_input_edges_table
...
def orchestrate_get_stats_dictionary_base_model_proxy_connectors_processed(
        ...
        -> dict:
    base_model_processed_proxy_connectors_input_edges_table = \
        get_processed_proxy_connectors_common_input_edges_table(
            ea_connectors=ea_connectors,
            ea_classifiers=ea_classifiers)

    base_model_processed_proxy_connectors_multi_edged_directed_graph = \
    ...
    base_model_processed_proxy_connectors_dictionary_of_stats = \
        __get_base_model_processed_proxy_connectors_dictionary_of_stats(
...
def __get_base_model_processed_proxy_connectors_dictionary_of_stats(
    ...
    base_model_processed_proxy_connectors_dictionary_of_stats_summary_table = \
    ...
    base_model_processed_proxy_connectors_dictionary_of_stats = \
        add_summary_table_to_dictionary_of_stats(
            ...
            stats_summary_table_name=output_summary_table_prefix + '_summary_table')
