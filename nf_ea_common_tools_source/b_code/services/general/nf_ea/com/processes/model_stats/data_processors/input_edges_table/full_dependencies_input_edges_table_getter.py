...
from nf_ea_common_tools_source.b_code.services.general.nf_ea.com.processes.model_stats.common.constants import DEPENDENT_COLUMN_NAME
from nf_ea_common_tools_source.b_code.services.general.nf_ea.com.processes.model_stats.common.constants import PROVIDER_COLUMN_NAME
from nf_ea_common_tools_source.b_code.services.general.nf_ea.com.processes.model_stats.common.constants import IMPLICIT_DEPENDENCY_NAME
...
def get_full_dependencies_input_edges_table(
    ...
    full_dependencies_input_edges_base_table = \
        __get_full_dependencies_input_edges_base_table(
            ea_full_dependencies=ea_full_dependencies,
            ea_connectors=ea_connectors)

    full_dependencies_input_edges_human_readable_table = \
...
def __get_full_dependencies_input_edges_base_table(
    ...
    full_dependencies_input_edges_base_table.loc[
        full_dependencies_input_edges_base_table[NfEaComColumnTypes.CONNECTORS_ELEMENT_TYPE_NAME.column_name] != EaConnectorTypes.DEPENDENCY.type_name,
        NfEaComColumnTypes.CONNECTORS_ELEMENT_TYPE_NAME.column_name] = \
