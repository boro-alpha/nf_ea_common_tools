...
from nf_ea_common_tools_source.b_code.services.general.nf_ea.com.processes.model_stats.common.services.graph_services.paths_and_path_depths_table_from_path_list_getter import get_paths_and_path_depths_table_from_path_list
from nf_ea_common_tools_source.b_code.services.general.nf_ea.com.processes.model_stats.common.constants import \
    PATHS_COLUMN_NAME, LEAVES_COLUMN_NAME, PATH_LEVEL_DEPTH_COLUMN_NAME, EA_OBJECT_NAME_COLUMN_NAME, \
    EA_OBJECT_TYPE_COLUMN_NAME, NF_UUIDS_COLUMN_NAME, LEAVES_NAME_COLUMN_NAME, LEAVES_TYPE_COLUMN_NAME, \
    FIRST_CLASS_RELATION_NAME, HIGH_ORDER_TYPE_RELATION_NAME, PROXYCONNECTOR_TYPE_NAME, ASSOCIATION_TYPE_NAME, \
    CLASS_TYPE_NAME, OBJECT_TYPE_NAME, RELATION_TYPE_COLUMN_NAME
...
def get_full_dependencies_path_analysis_master_table(
    ...
    path_analysis_master_table_with_leaves = \
        __add_leaves_to_path_analysis_master_table(
            full_dependencies_path_analysis_master_table=paths_and_path_depths_table,
            all_paths_list=all_paths_list)

    path_analysis_master_table_with_leaf_names_and_types = \
        __add_leaf_names_and_types_to_path_analysis_master_table(
    ...
    full_dependencies_path_analysis_master_table = \
        __add_leaf_high_relation_type_to_path_analysis_master_table(
...
def __add_leaves_to_path_analysis_master_table(
    ...
    for path in all_paths_list:
        ...
        list_of_leaves.append(
            path[0])

    paths_and_leaves_dictionary[PATHS_COLUMN_NAME] = \
        list_of_paths

    paths_and_leaves_dictionary[LEAVES_COLUMN_NAME] = \
        list_of_leaves
    ...
    path_analysis_master_table_with_leaves = \
        left_merge_dataframes(
            ...
            master_dataframe_key_columns=[PATHS_COLUMN_NAME],
            merge_suffixes=['1', '2'],
            foreign_key_dataframe=paths_and_leaves_table,
            foreign_key_dataframe_fk_columns=[PATHS_COLUMN_NAME],
...
def __add_leaf_names_and_types_to_path_analysis_master_table(
    ...
    data_visualisation_table_with_object_information = \
        left_merge_dataframes(
            master_dataframe=full_dependencies_path_analysis_master_table,
            master_dataframe_key_columns=[LEAVES_COLUMN_NAME],
            merge_suffixes=['1', '2'],
...
def __add_leaf_high_relation_type_to_path_analysis_master_table(
    ...
    high_relation_type_conditions = \
        [(full_dependencies_path_analysis_master_table[
              LEAVES_TYPE_COLUMN_NAME] == PROXYCONNECTOR_TYPE_NAME),
         (full_dependencies_path_analysis_master_table[
              LEAVES_TYPE_COLUMN_NAME] == ASSOCIATION_TYPE_NAME),
         (full_dependencies_path_analysis_master_table[
              LEAVES_TYPE_COLUMN_NAME] == CLASS_TYPE_NAME),
         (full_dependencies_path_analysis_master_table[
              LEAVES_TYPE_COLUMN_NAME] == OBJECT_TYPE_NAME)]

    full_dependencies_path_analysis_master_table[
        RELATION_TYPE_COLUMN_NAME] = \
        numpy.select(
            high_relation_type_conditions, high_relation_type)
