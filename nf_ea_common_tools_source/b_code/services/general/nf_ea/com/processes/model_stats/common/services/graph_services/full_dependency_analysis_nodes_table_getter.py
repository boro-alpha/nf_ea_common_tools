...
from nf_ea_common_tools_source.b_code.services.general.nf_ea.com.processes.model_stats.common.constants import PATHS_COLUMN_NAME, RELATION_TYPE_COLUMN_NAME, NF_UUIDS_COLUMN_NAME, LEAVES_COLUMN_NAME
...
from nf_ea_common_tools_source.b_code.services.general.nf_ea.com.processes.model_stats.common.services.graph_services.nodes_table_from_table_with_unique_paths_column_getter import get_nodes_base_table_with_node_max_levels_from_paths_table
...
def get_full_dependency_analysis_nodes_table(
        ...
        -> DataFrame:
    full_dependency_analysis_nodes_base_table_with_max_levels = \
...
def __add_data_to_nodes_table(
    ...
    nodes_table_with_leaf_high_relation_types = \
        __add_leaves_high_relation_type_to_nodes_table(
            full_dependencies_path_analysis_master_table=full_dependencies_path_analysis_master_table,
...
def __add_leaves_high_relation_type_to_nodes_table(
    ...
    nodes_dataframe_attributes_added = \
        left_merge_dataframes(
            ...
            foreign_key_dataframe_fk_columns=[LEAVES_COLUMN_NAME],
            foreign_key_dataframe_other_column_rename_dictionary=foreign_key_name_column_names
        ).drop_duplicates(subset=NF_UUIDS_COLUMN_NAME)

    nodes_table_with_leaf_high_relation_types = \
        nodes_dataframe_attributes_added.drop_duplicates(
