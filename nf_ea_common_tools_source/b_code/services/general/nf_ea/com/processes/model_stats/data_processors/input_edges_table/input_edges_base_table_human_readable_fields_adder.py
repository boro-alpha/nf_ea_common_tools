...
from nf_ea_common_tools_source.b_code.services.general.nf_ea.com.processes.model_stats.common.constants import TARGET_NAME_COLUMN_NAME
from nf_ea_common_tools_source.b_code.services.general.nf_ea.com.processes.model_stats.common.constants import SOURCE_NAME_COLUMN_NAME
...
def add_human_readable_fields_to_input_edges_base_table(
    ...
    input_edges_human_readable_table = \
        __add_source_name_to_input_edges_table(
            input_edges_table=input_edges_base_table,
            ea_classifiers=ea_classifiers)

    input_edges_human_readable_table = \
        __add_target_name_column_to_input_edges_table(
...
def __add_source_name_to_input_edges_table(
        ...
        ea_classifiers: DataFrame)\
        -> DataFrame:
    input_edges_base_table_with_source_name = \
...
def __add_target_name_column_to_input_edges_table(
        ...
        ea_classifiers: DataFrame)\
        -> DataFrame:
    input_edges_base_table_with_target_name = \
        left_merge_dataframes(
            master_dataframe=input_edges_table,
