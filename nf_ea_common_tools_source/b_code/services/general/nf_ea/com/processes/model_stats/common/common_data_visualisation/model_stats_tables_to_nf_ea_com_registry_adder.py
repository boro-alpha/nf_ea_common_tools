...
def add_model_stats_tables_to_nf_ea_com_registry(
    ...
    for collection in NfEaComCollectionTypes:
        for stats_table_name, stats_table in model_stats_tables.items():
            if collection.collection_name == stats_table_name:
                nf_ea_com_registry.dictionary_of_collections[collection] = \
                    stats_table
