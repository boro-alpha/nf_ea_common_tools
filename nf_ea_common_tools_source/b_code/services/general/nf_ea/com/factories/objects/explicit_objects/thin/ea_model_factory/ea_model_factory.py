...
def get_ea_models(
    ...
    extended_t_object_dataframe = \
        nf_ea_com_universe.ea_tools_session_manager.nf_ea_sql_stage_manager.nf_ea_sql_universe_manager.get_extended_ea_t_table_dataframe(
    ...
    ea_models = \
        ea_models.loc[ea_models['nullable'] == DEFAULT_NULL_VALUE]
    ...
    ea_models = \
        left_merge_dataframes(
            ...
            merge_suffixes=['_model', '_package'],
            foreign_key_dataframe=extended_t_package_dataframe,
            foreign_key_dataframe_fk_columns=[EaTPackageColumnTypes.T_PACKAGE_EA_GUIDS.nf_column_name],
            foreign_key_dataframe_other_column_rename_dictionary=
            {
