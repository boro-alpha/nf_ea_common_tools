...
from nf_ea_common_tools_source.b_code.services.general.nf_ea.com.common_knowledge.column_types.nf_ea_com_column_types import \
    NfEaComColumnTypes
from nf_ea_common_tools_source.b_code.services.general.nf_ea.com.factories.common.list_adder import add_list
...
class ThinEaPackagesFactories:
    ...
    def __create_ea_packages(
        ...
        ea_packages[NfEaComColumnTypes.PACKAGES_VIEW_TYPE.column_name] = \
            DEFAULT_NULL_VALUE
        ...
        ea_packages = \
            left_merge_dataframes(
                ...
                master_dataframe_key_columns=[package_ea_guid_column_name],
                merge_suffixes=['_package', '_client'],
        ...
        ea_packages[nf_uuids_column_name] = \
            ea_packages[nf_uuids_column_name].apply(
                lambda nf_uuid:
                create_new_uuid()
                if (isnull(nf_uuid))
                else nf_uuid)
    ...
    def __add_lists(
        ...
        ea_package_objects = \
            extended_t_object_dataframe.loc[extended_t_object_dataframe[EaTObjectColumnTypes.T_OBJECT_TYPES.nf_column_name] == EaElementTypes.PACKAGE.type_name]
        ...
        ea_package_objects = \
            left_merge_dataframes(
                ...
                master_dataframe_key_columns=['t_object_package_ea_guids'],
                merge_suffixes=['_object', '_package'],
                foreign_key_dataframe=ea_packages,
                foreign_key_dataframe_fk_columns=[package_ea_guid_column_name],
                foreign_key_dataframe_other_column_rename_dictionary={
        ...
        ea_packages = \
            add_list(
                ...
                foreign_key_dataframe_fk_columns=['t_object_package_nf_uuids'],
