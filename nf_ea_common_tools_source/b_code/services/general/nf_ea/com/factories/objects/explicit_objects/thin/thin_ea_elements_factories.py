    ...
    def __add_lists(
        ...
        ea_elements = \
            add_list(
                ...
                foreign_key_dataframe_fk_columns=['start_t_object_nf_uuids'],
        ...
        ea_elements = \
            add_list(
                master_dataframe=ea_elements,
                foreign_key_dataframe=extended_t_connector_dataframe,
                foreign_key_dataframe_fk_columns=['end_t_object_nf_uuids'],
        ...
        ea_elements = \
            add_list(
                ...
                foreign_key_dataframe_fk_columns=['t_diagram_package_nf_uuids'],
    ...
    def __add_fields(
        ...
        ea_element_components = \
            left_merge_dataframes(
                ...
                merge_suffixes=['_element', '_object'],
