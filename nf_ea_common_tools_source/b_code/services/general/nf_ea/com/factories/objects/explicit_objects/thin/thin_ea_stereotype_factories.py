from nf_common_source.code.services.dataframe_service.dataframe_helpers.dataframe_standardiser import fill_up_all_empty_cells_with_default_null_value
...
class ThinEaStereotypesFactories:
    ...
    def __add_fields(
            ...
            -> DataFrame:
        ea_stereotypes = \
            self.__replace_stereotype_group_name_with_link(
                ea_stereotypes=ea_stereotypes)
    ...
    def __replace_stereotype_group_name_with_link(
        ...
        ea_stereotypes = \
            left_merge_dataframes(
                ...
                master_dataframe_key_columns=['stereotype_group_names'],
                merge_suffixes=['_stereotype', '_stereotype_group'],
