...
class StereotypedObjectsUniverseFromGroupFactories:
    ...
    def create(
        ...
        ea_stereotype_group = \
            ea_stereotype_groups.loc[ea_stereotype_groups[object_name_column_name] == self.stereotype_group_name]
        ...
        ea_stereotypes_of_group = \
            left_merge_dataframes(
                ...
                merge_suffixes=['_local', '_common'],
                foreign_key_dataframe=ea_stereotypes,
                foreign_key_dataframe_fk_columns=[stereotype_ea_stereotype_group_column_name],
        ...
        ea_stereotypes_of_group_dictionary = \
            ea_stereotypes_of_group.to_dict(
                'index')

        for row, value_dictionary in ea_stereotypes_of_group_dictionary.items():
            self.__create_table(
                stereotype_ea_guid=value_dictionary['stereotype_ea_guids'],
                stereotype_name=value_dictionary[NfEaComColumnTypes.STEREOTYPE_NAMES.column_name])
