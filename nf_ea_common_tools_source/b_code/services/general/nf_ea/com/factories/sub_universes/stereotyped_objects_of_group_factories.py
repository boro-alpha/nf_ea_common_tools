    ...
    def create(
        ...
        ea_stereotyped_objects_of_group = \
            left_merge_dataframes(
                ...
                foreign_key_dataframe_fk_columns=['stereotype_nf_uuids'],
                foreign_key_dataframe_other_column_rename_dictionary=
                {
        ...
        ea_stereotyped_objects_of_group = \
            ea_stereotyped_objects_of_group.fillna(
                DEFAULT_NULL_VALUE)

        ea_stereotyped_objects_of_group = \
            ea_stereotyped_objects_of_group.loc[
                ea_stereotyped_objects_of_group[nf_uuids_column_name] != DEFAULT_NULL_VALUE]
