...
from nf_common_source.code.services.dataframe_service.dataframe_helpers.dataframe_focus_minus_matched_other_getter import get_dataframe_focus_minus_matched_other
...
class IntersectionAndSymmetricDifferenceFactories:
    ...
    def create(
        ...
        symmetric_difference_in_table_1['match_types'] = \
            'in ' + self.input_table_1.name + ' only'
        ...
        symmetric_difference_in_table_2['match_types'] = \
            'in ' + self.input_table_2.name + ' only'
