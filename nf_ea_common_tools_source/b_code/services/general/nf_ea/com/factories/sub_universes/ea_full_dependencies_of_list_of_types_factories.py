...
class EaFullDependenciesOfListOfTypesFactories:
    ...
    def create(
        ...
        ea_full_dependencies_of_list_of_types = \
            ea_full_dependencies_of_list_of_types.fillna(
                DEFAULT_NULL_VALUE)

        ea_full_dependencies_of_list_of_types = \
            ea_full_dependencies_of_list_of_types.loc[
                ea_full_dependencies_of_list_of_types['dependent'] != DEFAULT_NULL_VALUE]
