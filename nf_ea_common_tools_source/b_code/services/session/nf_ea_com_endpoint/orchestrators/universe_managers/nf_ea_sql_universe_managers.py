...
from nf_ea_common_tools_source.b_code.services.general.nf_ea.sql.nf_ea_sql_universes import NfEaSqlUniverses
...
class NfEaSqlUniverseManagers(
    ...
    def get_extended_ea_t_table_dataframe(
            ...
            -> DataFrame:
        nf_ea_sql_universe = \
            self.__get_nf_ea_sql_universe(
                ea_repository=ea_repository)

        extended_ea_t_table_dataframe = \
    ...
    def export_all_registries(
        ...
        for ea_repository, nf_ea_sql_universe in self.nf_ea_sql_universe_dictionary.items():
    ...
    def __get_nf_ea_sql_universe(
            ...
            ea_repository: EaRepositories) \
            -> NfEaSqlUniverses:
        if ea_repository in self.nf_ea_sql_universe_dictionary:
            return \
                self.nf_ea_sql_universe_dictionary[ea_repository]

        nf_ea_sql_universe = \
            self.__create_nf_ea_sql_universe(
                ea_repository=ea_repository)
